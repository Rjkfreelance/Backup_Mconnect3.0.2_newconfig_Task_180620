...
const char* sendperiod;//Config send every msec (Additional 18/06/2020)
...
/*-----Additional Var---------*/
/*
unsigned long val = (unsigned long)sendperiod;
unsigned long periodSend = val;
*/

unsigned long periodSend = 10000;
unsigned long last_time = 0; 

const char* xdataContinue[23];
...
void sendmqtt()
{
  ...
  if (write_addeeprom >= 32000) //32000  //ถ้าเขียนถึง address ที่ 32000 ให้เอาข้อมูลทั้งหมดใส่ใน file sdcard
  {
    ...
    //Check data in arrsy xdataContinue
     ...
     //Serial.println("Clear Datapack array");
